...
create table film (id bigint not null, filename varchar(255), genre varchar(255), title varchar(2147483647), year varchar(255), user_id bigint, primary key (id));
create table film_rating (film_id bigint not null, user_id bigint not null, rating bigint, primary key (film_id, user_id));
create table user_role (user_id bigint not null, roles varchar(255));
create table usr (id bigint not null, active boolean not null, email varchar(255), password varchar(255), username varchar(255), primary key (id));
